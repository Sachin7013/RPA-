...
try:
    with sync_playwright() as p:
        ...
        try:
            ...
            # Check for multiple possible console URL patterns
            console_patterns = [
                "**/console/**",
            ...
            # Try to detect successful authentication by checking current URL
            ...
            while not authenticated and (time.time() - start_time) < max_wait_time:
                ...
                try:
                    # Look for AWS console navigation or service elements
                    console_elements = [
                        "[data-testid*='console']",
                        ".awsui-app-layout",
                        "nav[role='navigation']",
            ...
            if not authenticated:
                raise Exception("Authentication timeout - could not detect successful console access")
